...
#' BioDIGS Site metadata
#'
#' @description BioDIGS sampling site information in a clean format for use in R. For more about BioDIGS, see <https://biodigs.org/>.
#'
#' @details
...
#' BioDIGS soil property data
#'
#' @description BioDIGS soil property data in a clean format for use in R. For more about BioDIGS, see <https://biodigs.org/>. This data was graciously generated by the Soil Testing Lab at the University of Delaware.
#'
#' @details
#' | **Field Name** |      | **Description** |
#' |----------------|------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
BioDIGS_soil_data <- function(info = TRUE) {
  testing_data <- BioDIGSData:::getdata()
